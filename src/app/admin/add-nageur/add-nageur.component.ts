...
export class AddNageurComponent implements OnInit {
  ...
  constructor(private _snack:MatSnackBar,private _nageur:NageurService, private _router:Router,private _club: ClubService,private datepipe: DatePipe) {
    this.club =[]
   }
  ...
  formSubmit(){
    ...
    let latest_date = this.datepipe.transform(this.nageur.dateNaissance, 'MM-dd-yyyy') ;
    this.nageur.dateNaissance = latest_date!.toString();
    latest_date =  this.datepipe.transform(this.nageur.obliteration, 'MM-dd-yyyy') ;
    this.nageur.obliteration = latest_date!.toString();
    latest_date =  this.datepipe.transform(this.nageur.depot, 'MM-dd-yyyy') ;
    this.nageur.depot = latest_date!.toString();
